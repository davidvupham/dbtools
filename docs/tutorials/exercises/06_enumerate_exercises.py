"""
enumerate() Function Exercises - Progressive Difficulty
========================================================

Complete these exercises to master the enumerate() function.
Start with Exercise 1 and work your way up!

Run this file to test your solutions:
    python 06_enumerate_exercises.py
"""
...
# Write a function that returns a list of strings like: "0: apple", "1: banana", etc.
...
# ============================================================================
# TODO: Use enumerate() with start=1 to create a numbered list
#
# Your code here:
...
def create_numbered_list(items):
    ...
    # Your code here
    # Return a list of strings like: "1. apple", "2. banana", etc.
    pass
...
# ============================================================================
# TODO: Write a function that finds the index of a specific item using enumerate()
#
# Your code here:

def find_index(items, target):
    """Find the index of target in items, return -1 if not found"""
    # Use enumerate() instead of items.index()
    # Your code here
    pass
...
# ============================================================================
# TODO: Update even-indexed elements to uppercase using enumerate()
#
# Your code here:

def uppercase_even_indices(words):
    """Return new list with even-indexed words in uppercase"""
    # Use enumerate() to check if index is even
    # Your code here
    pass
...
# ============================================================================
# TODO: Find indices where two lists differ using enumerate()
#
# Your code here:

def find_differences(list1, list2):
    """Return list of indices where list1 and list2 differ"""
    # Use enumerate() to compare elements at each index
    # Your code here
    pass
...
# ============================================================================
# TODO: Process log lines and extract errors with line numbers
#
# Your code here:
...
def find_errors_in_log(log_lines):
    ...
    """
    # Use enumerate() with appropriate start index
    # Your code here
    pass
