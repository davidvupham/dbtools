...
if [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/step03_create_databases.sh" ]; then
    ...
    if [ $CREATE_DB_RESULT -eq 0 ] && [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step1_databases.sh" ]; then
        execute_step "Validate Databases" "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step1_databases.sh"
    fi
else
...
if [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/step04_populate_dev.sh" ]; then
    ...
    if [ $POPULATE_RESULT -eq 0 ] && [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step2_populate.sh" ]; then
        execute_step "Validate Populate" "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step2_populate.sh"
    fi
else
...
if [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/step05_generate_baseline.sh" ]; then
    ...
    if [ $BASELINE_RESULT -eq 0 ] && [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step4_baseline.sh" ]; then
        execute_step "Validate Baseline" "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step4_baseline.sh"
    fi
else
...
if [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/step06_deploy_baseline.sh" ]; then
    ...
    if [ $DEPLOY_RESULT -eq 0 ] && [ -f "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step5_deploy.sh" ]; then
        execute_step "Validate Deployment" "$LIQUIBASE_TUTORIAL_DIR/scripts/validate_step5_deploy.sh"
    fi
else
