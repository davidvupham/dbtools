...
class TestSnowflakeReplication(unittest.TestCase):
    ...
    def test_check_replication_failure_success(self):
        ...
        mock_history = [{"STATUS": "SUCCESS", "MESSAGE": None}]
    ...
    def test_check_replication_failure_failed(self):
        ...
        mock_history = [{"STATUS": "FAILED", "MESSAGE": "Connection timeout"}]
    ...
    def test_check_replication_failure_partially_failed(self):
        ...
        mock_history = [{"STATUS": "PARTIALLY_FAILED", "MESSAGE": "Some objects failed"}]
    ...
    def test_check_replication_latency_no_latency(self):
        ...
        fg = FailoverGroup("FG1", {"type": "PRIMARY", "replication_schedule": "USING CRON */10 * * * * UTC"})
        ...
        mock_history = [{"START_TIME": start_time, "END_TIME": end_time, "STATUS": "SUCCESS"}]
    ...
    def test_check_replication_latency_no_schedule(self):
        ...
        fg = FailoverGroup("FG1", {"type": "PRIMARY", "replication_schedule": ""})
    ...
    def test_check_replication_latency_invalid_schedule(self):
        ...
        fg = FailoverGroup("FG1", {"type": "PRIMARY", "replication_schedule": "INVALID"})
    ...
    def test_switch_to_secondary_account_from_primary(self):
        ...
        fg = FailoverGroup("FG1", {"type": "PRIMARY", "primary": "ACCOUNT1", "secondary_state": "ACCOUNT2:READY"})
    ...
    def test_switch_to_secondary_account_already_secondary(self):
        ...
        fg = FailoverGroup("FG1", {"type": "SECONDARY", "primary": "ACCOUNT1", "secondary_state": "ACCOUNT2:READY"})
    ...
    def test_switch_to_secondary_account_no_secondary(self):
        ...
        fg = FailoverGroup("FG1", {"type": "PRIMARY", "primary": "ACCOUNT1", "secondary_state": ""})
