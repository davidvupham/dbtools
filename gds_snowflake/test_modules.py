...
def test_module_structure():
    ...
    try:
        ...
        expected_methods = [
            'connect', 'close', 'get_connection', 'execute_query',
            'execute_query_dict', 'switch_account'
        ]
    ...
    try:
        ...
        expected_fg_methods = [
            'is_primary', 'get_secondary_account'
        ]
        ...
        expected_repl_methods = [
            'get_failover_groups', 'get_replication_history',
            'parse_cron_schedule', 'check_replication_failure',
            'check_replication_latency', 'switch_to_secondary_account'
        ]
