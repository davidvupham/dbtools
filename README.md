...
3. The dev container boots with Python, PowerShell 7, and other tooling preinstalled for a consistent environment
...
- In VS Code: Run Task → "Dev: Verify Dev Container" (default)
- Or from terminal:
...
- [Dev Container: Quickstart & Usage](docs/development/devcontainer.md)
  - [Verification steps](docs/development/devcontainer.md#verify)
- [Dev Container: Functional & Architecture Spec](docs/development/devcontainer-functional-spec.md)
- [Dev Container: Technical Architecture (with diagram)](docs/development/devcontainer-architecture.md)
