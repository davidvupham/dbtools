...
import os
from gds_vault import get_secret_from_vault, VaultClient, VaultError
...
def example_class_without_caching():
    ...
    try:
        ...
        print(f"✓ Retrieved 2 secrets without caching")
...
def example_class_with_caching():
    ...
    try:
        ...
        print(f"✓ Retrieved 3 unique secrets")
        print(f"✓ Second fetch of database secret used cache")
